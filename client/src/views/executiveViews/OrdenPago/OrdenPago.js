...
import {useConceptosPago} from "./useConceptosPago";
import {useConceptos, useSelectedData, useLocationData} from "./ConstantesYEstados"
...
const OrdenPago = () => {
    ...
    const options = useConceptosPago()
    ...
    const {
      ...
      merchantAdress,
      merchantFullName,
    } = useLocationData({shop, merchant, setDateFormat, Data});
    ...
    return (
      <>
        ...
        <footer
          className="flex flex-col m-6 sm:mx-4 md:grid md:grid-cols-2 md:gap-4 lg:mx-16 lg:grid lg:grid-cols-3 mt-16 2xl:mt-24">
