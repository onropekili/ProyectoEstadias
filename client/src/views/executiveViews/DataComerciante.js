...
const DataComerciante = () => {
    ...
    const VerificarFormatoBaja = () => {
      axios.get(`http://${process.env.REACT_APP_HOST}:4000/availableToCancel?id_comercio=${folio}`)
        .then((res) => {
            if (res.status === 200) {
              console.log(res.data)
              navigate(`/Formato-baja-comercio/${folio}`)
            }
          }
        )
        .catch((error) => {
                ...
                <div className="w-full">
                  ...
                  <form>
                    <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-x-6 pb-8 lg:pb-0">
                      ...
                      <section className="col-span-1 px-4 mb-6 md:mb-0">
                        <div className="text-start flex justify-between items-center">
                          ...
                          <span
                            className="text-lg font-Foco-Corp font-semibold text-gris mb-6 md:mb-4">
                          Folio:{" "}
                            <span>
                            {data
                        ...
                        <div
                          className="flex flex-col gap-x-4 gap-y-4 xl:grid xl:grid-cols-2 lg:gap-y-2 2xl:gap-y-3">
                      ...
                      <section className="col-span-1 px-4">
                        ...
                        <div
                          className="flex flex-col gap-x-4 gap-y-4 xl:grid xl:grid-cols-4 lg:gap-y-2">
                          <div className="flex flex-col col-span-2 ">
                            <label
                    ...
                    {showButtonsTab1 && (
                      <div>
                        <div
                          className="w-full flex flex-col md:flex-row py-8 md:py-4 2xl:py-8 px-4 rounded-b-lg gap-4 lg:gap-10 bg-gray-50 justify-end">
                          <button
                  ...
                  <form>
                    <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-x-6 pb-8 lg:pb-1 2xl:pb-2">
                      ...
                      <section className="col-span-1 px-4 mb-6 md:mb-0">
                        ...
                        <div
                          className="flex flex-col gap-x-4 gap-y-4 xl:grid xl:grid-cols-4 lg:gap-y-2 2xl:gap-y-3">
                          <div className="flex flex-col col-span-2 ">
                            <label
